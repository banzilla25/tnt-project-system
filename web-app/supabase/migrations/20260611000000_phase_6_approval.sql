-- Add columns
ALTER TABLE campaigns ADD COLUMN IF NOT EXISTS require_client_approval BOOLEAN DEFAULT FALSE;
...
GROUP BY c.id, c.nama, b.nama, c.status, c.tipe_campaign, c.start_date, c.end_date, c.target_gmv, c.target_video, c.budget_creator_plafon, c.budget_ads_plafon, c.vsa_gmv_max, c.pic, c.assist, c.require_client_approval;
